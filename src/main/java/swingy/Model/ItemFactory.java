...
public final class ItemFactory
{
	...
	private static final double LEVEL_LOG_MULTIPLIER = 0.055;
	...
	{
		return stat * (1.0 + Math.log(villain_level) * (LEVEL_LOG_MULTIPLIER * Math.log(villain_level)));
	}
	...
	private static final List<Item> EPIC_TEMPLATES = List.of(
		...
		new Item(Item.Type.HELMET, Item.Rarity.EPIC, "Dragoncrest Helm", "Adorned with a dragon motif, brings occasional fortunate outcomes", Map.of(StatisticTemplate.Type.LUCK, new Statistic(StatisticTemplate.Type.LUCK, 0))),
	...
	private static final List<Item> LEGENDARY_TEMPLATES = List.of(
		...
		new Item(Item.Type.WEAPON, Item.Rarity.LEGENDARY, "Axe of Endless Carnage", "Every drop of blood makes the blade hungrier", Map.of(StatisticTemplate.Type.CRIT_DAMAGE, new Statistic(StatisticTemplate.Type.CRIT_DAMAGE, 0), StatisticTemplate.Type.SPEED, new Statistic(StatisticTemplate.Type.SPEED, 0))),
